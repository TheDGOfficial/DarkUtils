...
/**
 * A basic event listener that delegates to another with custom priority and receiveCancelled behaviour.
 *
 * @param listener         The base listener to be used as a delegate.
 * @param priority         The custom {@link EventPriority} priority.
 * @param receiveCancelled The custom receiveCancelled behaviour.
