...
public final class DarkUtilsConfigScreen {
    ...
    private static final void addFarming(@NotNull final DarkUtilsConfig config, @NotNull final ConfigBuilder builder, @NotNull final ConfigEntryBuilder entryBuilder) {
        ...
        DarkUtilsConfigScreen.addSimpleBooleanToggle(entryBuilder, farming, "Open Equipment Menu when Cooldown Over or Pests Spawned",
                "Opens Equipment Menu by sending /eq command automatically when your Pest Cooldown is over, and opens it again once you spawn some pests. Useful if swapping between Pest Equipment and regular Farming equipment.",
                config.openEquipmentMenuWhenOverOrSpawn, newValue -> config.openEquipmentMenuWhenOverOrSpawn = newValue);
